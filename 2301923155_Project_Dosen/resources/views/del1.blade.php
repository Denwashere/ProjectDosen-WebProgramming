  ...
  <thead class="bg-dark">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td> 2 </td>
            <td> 36.000 </td>
            <td> <a type="submit" class="btn btn-danger" href="/del2">Delete</a></td>
        </tr>   
...
<a class="text-light">____________________________________________________________________________________________________________________________________________________________</a> <a class="text-dark text-decoration-none">Grand Total: Rp. 56.000,-</a>
