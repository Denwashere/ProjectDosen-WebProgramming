            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="dropdown-menu">
                         ...
                         <li><a class="dropdown-item" href="/milkshake">Milkshake</a></li>
                         <li><a class="dropdown-item" href="/softdrink">Soft Drink</a></li>
                    </ul>
                    </li>
                    ...
                    <form class="d-flex">
                        ...
                        <a class="btn btn-success" type="submit" href="/checkout">Checkout</a>

                        <a class="text-danger">__________________</a>
